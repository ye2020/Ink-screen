...
void click2() 
{
  ...
  button0_current_state = button_click;    // 更新状态
} 
...
void doubleclick2() 
{
  ...
  button0_current_state = button_doubleclick;    // 更新状态
} 
...
void longPressStart2()
{
  ...
  button0_current_state = button_longPressStart;    // 更新状态
}
...
void longPress2() 
{
  ...
  button0_current_state = button_longPress;    // 更新状态
} 

void longPressStop2() 
{
  Serial.println("Button 2 longPress stop");
  button0_current_state = button_longPressStop;    // 更新状态
}
